    ...
    return (
        <nav className='navbar'>
            ...
            <div className='desktopMenu'>
                ...
                <Link activeClass='active' to='works' spy={true} smooth={true} offset={-75} duration={500} className='desktopMenuListItem'>Projects</Link>
            ...
            <div className='navMenu' style={{display:showMenu?'flex':"none"}}>
                ...
                <Link activeClass='active' to='contact' spy={true} smooth={true} offset={-100} duration={500} className='listItem' onClick={()=>setShowMenu(false)}>Connect</Link>
            </div>
        </nav>
    )
}
